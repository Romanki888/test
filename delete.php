...
<html>
 <head>
  <title>Удаление строк из базы</title>  
 ...
 <body>
       <h1 align="center"  >Удаление строк из базы</h1>
...
<style>
  ...
  .like {
    margin-right: 10px;
            ...
            <a href="index.php"  class="btn btn-success" id="send" >
                <i class="bi bi-send" ></i> Вернуться на страницу загрузки CSV
            </a>      
